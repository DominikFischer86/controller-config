...
export default function Editor({ hideBoxes, hideEmptyInputs, drawerSide, handleHideInput, handleHideBox, closeDrawer }: Props) {
    ...
    return (
        <div className={styles.editor}>
            <div className={styles.controlPanel}>
                ...
                <button onClick={handleHideBox}>{hideBoxes ? "Hide" : "Show"} all input boxes</button>
            </div>
